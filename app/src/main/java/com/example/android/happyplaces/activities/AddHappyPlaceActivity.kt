...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddHappyPlaceBinding.inflate(LayoutInflater.from(this))
    ...
    override fun onClick(v: View?) {
        when(v!!.id){
            ...
            R.id.tv_add_image ->{
                ...
                val pickerDialogItems = arrayOf("Select photo form Gallery", "Capture photo from Camera")
